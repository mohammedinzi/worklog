window.WORKLOG_ENTRIES = [
  ...
  },
  {
    ...
    "time": null,
    "status": "warn",
    "statusLabel": "Scoped out · not committed",
    ...
    "detail": "<p>The sheet's \"READY FOR DISPATCH\" tally block (per-model dispatch counts) was explicitly scoped out — its business meaning can't be confirmed against existing masters, so it was flagged rather than built on a guess.</p><p>No git commit, per standing build-only policy. No real browser/Desk click-test ran this session — no live credentials available, hence the Node-mocked verification above instead.</p>",
    "detailText": "The sheet's \"READY FOR DISPATCH\" tally block (per-model dispatch counts) was explicitly scoped out — its business meaning can't be confirmed against existing masters, so it was flagged rather than built on a guess. No git commit, per standing build-only policy. No real browser/Desk click-test ran this session — no live credentials available, hence the Node-mocked verification above instead.",
    "phase": "Daily Production Register — Build & Hardening",
    "phaseId": "phase-26",
    "projectId": "pixeled-erp",
    "project": "Pixeled ERP"
  ...
  },
  {
    ...
    "time": null,
    "status": "warn",
    "statusLabel": "Not committed · not click-tested",
